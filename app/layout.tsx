...
export const metadata: Metadata = {
  ...
  metadataBase: new URL("https://familyhome.yiangouweb.com"),
  openGraph: {
    title: "Family Home | 4-Bedroom Villa in Protaras, Cyprus",
    description: "Book direct and save. Rated 9.9/10, just 250m from Vyzakia Beach.",
    url: "https://familyhome.yiangouweb.com",
...
const jsonLd = {
  ...
  url: "https://familyhome.yiangouweb.com",
  image: [
    "https://familyhome.yiangouweb.com/photos/photo-01.jpg",
    "https://familyhome.yiangouweb.com/photos/photo-02.jpg",
    "https://familyhome.yiangouweb.com/photos/photo-03.jpg",
  ],
  address: {
    "@type": "PostalAddress",
